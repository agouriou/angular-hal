...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function ResourceFactory(e,t,r,n){function i(u,o){function f(){for(var e in u)u.hasOwnProperty(e)&&(y(e)||(0,_defineReadOnly2["default"])(k,e,u[e]))}function a(){"object"===_typeof(u[t.linksAttribute])&&Object.keys(u[t.linksAttribute]).forEach(function(e){var r=u[t.linksAttribute][e];A[e]=(0,_normalizeLink2["default"])(o.config.url,r)})}function l(){"object"===_typeof(u[t.embeddedAttribute])&&Object.keys(u[t.embeddedAttribute]).forEach(function(e){c(e,u[t.embeddedAttribute][e])})}function d(){g=new e(k,O)}function c(e,t){return Array.isArray(t)?(O[e]=[],void t.forEach(function(t){O[e].push(new i(t,o))})):void(O[e]=new i(t,o))}function y(e){for(var r=0;r<t.ignoreAttributePrefixes.length;r++){if(e.substr(0,1)===t.ignoreAttributePrefixes[r])return!0;if(e===t.linksAttribute||e===t.embeddedAttribute)return!0}return!1}function s(e){return"undefined"!=typeof A[e]}function p(e){return"undefined"!=typeof O[e]}function b(e){return s(e)||p(e)}function _(e,r){var i=m(e),u=i.href;if(Array.isArray(i)){u=[];for(var o=0;o<i.length;o++){var f=i[o],a=f.href;"undefined"!=typeof f.templated&&f.templated&&(a=(0,_generateUrl2["default"])(f.href,r)),a=t.urlTransformer(a),u.push(a)}}else{if("undefined"!=typeof i.templated&&i.templated)u=(0,_generateUrl2["default"])(i.href,r);else if(r){var l=n(r);l&&""!==l&&(u+="?"+l)}u=t.urlTransformer(u)}return u}function m(e){if(!s(e))throw new Error('link "'+e+'" is undefined');var t=A[e];return"undefined"!=typeof t.deprecation&&r.warn('The link "'+e+'" is marked as deprecated with the value "'+t.deprecation+'".'),t}function h(e){for(var r=0;r<t.ignoreAttributePrefixes.length;r++){var n=t.ignoreAttributePrefixes[r]+e;return u[n]}}function v(){return o}function R(){return g}var g,k=this,A={},O={};!function(){"object"===("undefined"==typeof u?"undefined":_typeof(u))&&null!==u||(u={}),f(),l(),a(),d(),(0,_extendReadOnly2["default"])(k,{$hasLink:s,$hasEmbedded:p,$has:b,$href:_,$meta:h,$link:m,$request:R,$response:v})}()}return i}Object.defineProperty(exports,"__esModule",{value:!0});var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e};exports["default"]=ResourceFactory;var _extendReadOnly=require("../utility/extend-read-only"),_extendReadOnly2=_interopRequireDefault(_extendReadOnly),_defineReadOnly=require("../utility/define-read-only"),_defineReadOnly2=_interopRequireDefault(_defineReadOnly),_generateUrl=require("../utility/generate-url"),_generateUrl2=_interopRequireDefault(_generateUrl),_normalizeLink=require("../utility/normalize-link"),_normalizeLink2=_interopRequireDefault(_normalizeLink);ResourceFactory.$inject=["HalResourceClient","$halConfiguration","$log","$httpParamSerializer"];
